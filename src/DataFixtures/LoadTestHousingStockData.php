...
class LoadTestHousingStockData extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $vtw1 = new Vtw();
        $vtw1->setCode('WT 1');
        $vtw1->setName('eengezinswoning');
        $vtw1->setBuildingType('1');
        $vtw1->setConstructionYear('voor 1950');
        $vtw1->setRoofType('hellend dak');

        $vtw2 = new Vtw();
        $vtw2->setCode('WT 1R');
        $vtw2->setName('renovatie eengezinswoning');
        $vtw2->setBuildingType('1R');
        $vtw2->setConstructionYear('voor 1950');
        $vtw2->setRoofType('hellend dak');

        $vtw3 = new Vtw();
        $vtw3->setCode('WT 2');
        $vtw3->setName('eengezinswoning');
        $vtw3->setBuildingType('2');
        $vtw3->setConstructionYear('tussen 1950 en 1970');
        $vtw3->setRoofType('hellend dak');

        $vtw4 = new Vtw();
        $vtw4->setCode('WT 2R');
        $vtw4->setName('renovatie eengezinswoning');
        $vtw4->setBuildingType('2R');
        $vtw4->setConstructionYear('tussen 1950 en 1970');
        $vtw4->setRoofType('hellend dak');

        $vtw5 = new Vtw();
        $vtw5->setCode('WT 3');
        $vtw5->setName('eengezinswoning');
        $vtw5->setBuildingType('3');
        $vtw5->setConstructionYear('tussen 1950 en 1970');
        $vtw5->setRoofType('hellend dak');

        $vtw6 = new Vtw();
        $vtw6->setCode('WT 4');
        $vtw6->setName('eengezinswoning/senioren-woning');
        $vtw6->setBuildingType('4');
        $vtw6->setConstructionYear('tussen 1990 en 2000');
        $vtw6->setRoofType('hellend dak');

        $vtw7 = new Vtw();
        $vtw7->setCode('WT 5');
        $vtw7->setName('eengezinswoning');
        $vtw7->setBuildingType('5');
        $vtw7->setConstructionYear('tussen 1990 en 2000');
        $vtw7->setRoofType('hellend dak');

        $vtw8 = new Vtw();
        $vtw8->setCode('WT 6');
        $vtw8->setName('eengezinswoning');
        $vtw8->setBuildingType('6');
        $vtw8->setConstructionYear('na 2000');
        $vtw8->setRoofType('hellend dak');

        $vtw9 = new Vtw();
        $vtw9->setCode('WT 7R');
        $vtw9->setName('renovatie eengezinswoning');
        $vtw9->setBuildingType('7R');
        $vtw9->setConstructionYear('tussen 1950 en 1970');
        $vtw9->setRoofType('hellend dak');

        $vtw10 = new Vtw();
        $vtw10->setCode('WT 8');
        $vtw10->setName('eengezinswoning');
        $vtw10->setBuildingType('8');
        $vtw10->setConstructionYear('tussen 1970 en 1990');
        $vtw10->setRoofType('hellend dak');

        $vtw11 = new Vtw();
        $vtw11->setCode('WT 9');
        $vtw11->setName('eengezinswoning');
        $vtw11->setBuildingType('9');
        $vtw11->setConstructionYear('tussen 1990 en 2000');
        $vtw11->setRoofType('hellend dak');

        $vtw12 = new Vtw();
        $vtw12->setCode('WT 10');
        $vtw12->setName('eengezinswoning');
        $vtw12->setBuildingType('10');
        $vtw12->setConstructionYear('na 2000');
        $vtw12->setRoofType('hellend dak');

        $vtw13 = new Vtw();
        $vtw13->setCode('WT 11');
        $vtw13->setName('eengezinswoning');
        $vtw13->setBuildingType('11');
        $vtw13->setConstructionYear('tussen 1950 en 1970');
        $vtw13->setRoofType('vlak dak');

        $vtw14 = new Vtw();
        $vtw14->setCode('WT 11R');
        $vtw14->setName('renovatie eengezinswoning');
        $vtw14->setBuildingType('11R');
        $vtw14->setConstructionYear('tussen 1950 en 1970');
        $vtw14->setRoofType('vlak dak');

        $vtw15 = new Vtw();
        $vtw15->setCode('WT 12');
        $vtw15->setName('eengezinswoning');
        $vtw15->setBuildingType('12');
        $vtw15->setConstructionYear('tussen 1970 en 1990');
        $vtw15->setRoofType('vlak dak');

        $vtw16 = new Vtw();
        $vtw16->setCode('WT 13');
        $vtw16->setName('eengezinswoning');
        $vtw16->setBuildingType('13');
        $vtw16->setConstructionYear('na 1990');
        $vtw16->setRoofType('vlak dak');

        $vtw17 = new Vtw();
        $vtw17->setCode('WT 14');
        $vtw17->setName('open portiekwoning');
        $vtw17->setBuildingType('14');
        $vtw17->setConstructionYear('voor 1950');
        $vtw17->setRoofType('hellend dak');

        $vtw18 = new Vtw();
        $vtw18->setCode('WT 14R');
        $vtw18->setName('eengezinswoning');
        $vtw18->setBuildingType('14R');
        $vtw18->setConstructionYear('voor 1950');
        $vtw18->setRoofType('hellend dak');

        $vtw19 = new Vtw();
        $vtw19->setCode('WT 15');
        $vtw19->setName('open portiekwoning');
        $vtw19->setBuildingType('15');
        $vtw19->setConstructionYear('voor 1950');
        $vtw19->setRoofType('vlak dak');

        $vtw20 = new Vtw();
        $vtw20->setCode('WT 15R');
        $vtw20->setName('renovatie open portiekwoning');
        $vtw20->setBuildingType('15R');
        $vtw20->setConstructionYear('voor 1950');
        $vtw20->setRoofType('vlak dak');

        $vtw21 = new Vtw();
        $vtw21->setCode('WT 16');
        $vtw21->setName('etagewoning');
        $vtw21->setBuildingType('16');
        $vtw21->setConstructionYear('voor 1950');
        $vtw21->setRoofType('hellend dak');

        $vtw22 = new Vtw();
        $vtw22->setCode('WT 16R');
        $vtw22->setName('renovatie etagewoning');
        $vtw22->setBuildingType('16R');
        $vtw22->setConstructionYear('voor 1950');
        $vtw22->setRoofType('hellend dak');

        $vtw23 = new Vtw();
        $vtw23->setCode('WT 17');
        $vtw23->setName('etagewoning');
        $vtw23->setBuildingType('17');
        $vtw23->setConstructionYear('voor 1950');
        $vtw23->setRoofType('vlak dak');

        $vtw24 = new Vtw();
        $vtw24->setCode('WT 17R');
        $vtw24->setName('renovatie etagewoning');
        $vtw24->setBuildingType('17R');
        $vtw24->setConstructionYear('voor 1950');
        $vtw24->setRoofType('vlak dak');

        $vtw25 = new Vtw();
        $vtw25->setCode('WT 18');
        $vtw25->setName('trappenhuisflat Amsterdamse school');
        $vtw25->setBuildingType('18');
        $vtw25->setConstructionYear('voor 1950');
        $vtw25->setRoofType('hellend dak');

        $vtw26 = new Vtw();
        $vtw26->setCode('WT 18R');
        $vtw26->setName('renovatie trappenhuisflat Amsterdamse school');
        $vtw26->setBuildingType('18R');
        $vtw26->setConstructionYear('voor 1950');
        $vtw26->setRoofType('hellend dak');

        $vtw27 = new Vtw();
        $vtw27->setCode('WT 19');
        $vtw27->setName('trappenhuisflat tot en met 4 lagen');
        $vtw27->setBuildingType('19');
        $vtw27->setConstructionYear('voor 1950');
        $vtw27->setRoofType('hellend dak');

        $vtw28 = new Vtw();
        $vtw28->setCode('WT 19R');
        $vtw28->setName('renovatie trappenhuisflat tot en met 4 lagen');
        $vtw28->setBuildingType('19R');
        $vtw28->setConstructionYear('voor 1950');
        $vtw28->setRoofType('hellend dak');

        $vtw29 = new Vtw();
        $vtw29->setCode('WT 20');
        $vtw29->setName('trappenhuisflat tot en met 4 lagen');
        $vtw29->setBuildingType('20');
        $vtw29->setConstructionYear('tussen 1950 en 1970');
        $vtw29->setRoofType('hellend dak');

        $vtw30 = new Vtw();
        $vtw30->setCode('WT 20R');
        $vtw30->setName('trappenhuisflat tot en met 4 lagen');
        $vtw30->setBuildingType('20R');
        $vtw30->setConstructionYear('tussen 1950 en 1970');
        $vtw30->setRoofType('hellend dak');

        $vtw31 = new Vtw();
        $vtw31->setCode('WT 21');
        $vtw31->setName('trappenhuisflat tot en met 4 lagen');
        $vtw31->setBuildingType('21');
        $vtw31->setConstructionYear('voor 1950');
        $vtw31->setRoofType('vlak dak');

        $vtw32 = new Vtw();
        $vtw32->setCode('WT 21R');
        $vtw32->setName('renovatie trappenhuisflat tot en met 4 lagen');
        $vtw32->setBuildingType('21R');
        $vtw32->setConstructionYear('voor 1950');
        $vtw32->setRoofType('vlak dak');

        $vtw33 = new Vtw();
        $vtw33->setCode('WT 22');
        $vtw33->setName('trappenhuisflat tot en met 4 lagen');
        $vtw33->setBuildingType('22');
        $vtw33->setConstructionYear('tussen 1950 en 1970');
        $vtw33->setRoofType('vlak dak');

        $vtw34 = new Vtw();
        $vtw34->setCode('WT 22R');
        $vtw34->setName('renovatie trappenhuisflat tot en met 4 lagen');
        $vtw34->setBuildingType('22R');
        $vtw34->setConstructionYear('tussen 1950 en 1970');
        $vtw34->setRoofType('vlak dak');

        $vtw35 = new Vtw();
        $vtw35->setCode('WT 23');
        $vtw35->setName('trappenhuisflat tot en met 4 lagen');
        $vtw35->setBuildingType('23');
        $vtw35->setConstructionYear('tussen 1970 en 1990');
        $vtw35->setRoofType('vlak dak');

        $vtw36 = new Vtw();
        $vtw36->setCode('WT 24');
        $vtw36->setName('trappenhuisflat tot en met 4 lagen');
        $vtw36->setBuildingType('24');
        $vtw36->setConstructionYear('na 1990');
        $vtw36->setRoofType('vlak dak');

        $vtw37 = new Vtw();
        $vtw37->setCode('WT 25');
        $vtw37->setName('trappenhuisflat tot en met 4 lagen');
        $vtw37->setBuildingType('25');
        $vtw37->setConstructionYear('na 1990');
        $vtw37->setRoofType('vlak dak');

        $vtw38 = new Vtw();
        $vtw38->setCode('WT 26');
        $vtw38->setName('trappenhuisflat tot en met 4 lagen');
        $vtw38->setBuildingType('26');
        $vtw38->setConstructionYear('na 1990');
        $vtw38->setRoofType('vlak dak');

        $vtw39 = new Vtw();
        $vtw39->setCode('WT 27');
        $vtw39->setName('trappenhuis-/corridorflat zgn. Urban villa tot en met 4 lagen');
        $vtw39->setBuildingType('27');
        $vtw39->setConstructionYear('na 1990');
        $vtw39->setRoofType('vlak en hellend dak');

        $vtw40 = new Vtw();
        $vtw40->setCode('WT 28');
        $vtw40->setName('trappenhuis-/corridorflat meer dan 4 lagen');
        $vtw40->setBuildingType('28');
        $vtw40->setConstructionYear('1950 en 1970');
        $vtw40->setRoofType('vlak dak');

        $vtw41 = new Vtw();
        $vtw41->setCode('WT 28R');
        $vtw41->setName('renovatie-trappenhuis-/corridorflat meer dan 4 lagen');
        $vtw41->setBuildingType('28R');
        $vtw41->setConstructionYear('tussen 1950 en 1970');
        $vtw41->setRoofType('vlak dak');

        $vtw42 = new Vtw();
        $vtw42->setCode('WT 29');
        $vtw42->setName('trappenhuis-/corridorflat meer dan 4 lagen');
        $vtw42->setBuildingType('29');
        $vtw42->setConstructionYear('tussen 1970 en 1990');
        $vtw42->setRoofType('vlak dak');

        $vtw43 = new Vtw();
        $vtw43->setCode('WT 30');
        $vtw43->setName('trappenhuis-/corridorflat meer dan 4 lagen');
        $vtw43->setBuildingType('30');
        $vtw43->setConstructionYear('na 1990');
        $vtw43->setRoofType('vlak dak');

        $vtw44 = new Vtw();
        $vtw44->setCode('WT 31');
        $vtw44->setName('galerijflat tot en met 2 lagen');
        $vtw44->setBuildingType('31');
        $vtw44->setConstructionYear('tussen 1950 en 1970');
        $vtw44->setRoofType('vlak dak');

        $vtw45 = new Vtw();
        $vtw45->setCode('WT 32');
        $vtw45->setName('galerijflat tot en met 4 lagen');
        $vtw45->setBuildingType('32');
        $vtw45->setConstructionYear('tussen 1950 en 1970');
        $vtw45->setRoofType('vlak dak');

        $vtw46 = new Vtw();
        $vtw46->setCode('WT 32R');
        $vtw46->setName('renovatie galerijflat tot en met 4 lagen');
        $vtw46->setBuildingType('32R');
        $vtw46->setConstructionYear('tussen 1950 en 1970');
        $vtw46->setRoofType('vlak dak');

        $vtw47 = new Vtw();
        $vtw47->setCode('WT 33');
        $vtw47->setName('galerijflat tot en met 4 lagen');
        $vtw47->setBuildingType('33');
        $vtw47->setConstructionYear('tussen 1970 en 1990');
        $vtw47->setRoofType('vlak dak');

        $vtw48 = new Vtw();
        $vtw48->setCode('WT 34');
        $vtw48->setName('galerijflat tot en met 4 lagen');
        $vtw48->setBuildingType('34');
        $vtw48->setConstructionYear('na 1970');
        $vtw48->setRoofType('vlak dak');

        $vtw49 = new Vtw();
        $vtw49->setCode('WT 35');
        $vtw49->setName('galerijflat meer dan 4 lagen');
        $vtw49->setBuildingType('35');
        $vtw49->setConstructionYear('tussen 1950 en 1970');
        $vtw49->setRoofType('vlak dak');

        $vtw50 = new Vtw();
        $vtw50->setCode('WT 35R');
        $vtw50->setName('renovatie galerijflat meer dan 4 lagen');
        $vtw50->setBuildingType('35R');
        $vtw50->setConstructionYear('tussen 1950 en 1970');
        $vtw50->setRoofType('vlak dak');

        $vtw51 = new Vtw();
        $vtw51->setCode('WT 36');
        $vtw51->setName('galerijflat meer dan 4 lagen');
        $vtw51->setBuildingType('36');
        $vtw51->setConstructionYear('tussen 1970 en 1990');
        $vtw51->setRoofType('vlak dak');

        $vtw52 = new Vtw();
        $vtw52->setCode('WT 37');
        $vtw52->setName('galerijflat meer dan 4 lagen');
        $vtw52->setBuildingType('37');
        $vtw52->setConstructionYear('na 1990');
        $vtw52->setRoofType('vlak dak');

        $vtw53 = new Vtw();
        $vtw53->setCode('WT 38R');
        $vtw53->setName('renovatie galerijmaisonnette meer dan 4 lagen');
        $vtw53->setBuildingType('38R');
        $vtw53->setConstructionYear('tussen 1950 en 1970');
        $vtw53->setRoofType('vlak dak');

        $vtw54 = new Vtw();
        $vtw54->setCode('WT 39R');
        $vtw54->setName('renovatie eengezinswoning');
        $vtw54->setBuildingType('39R');
        $vtw54->setConstructionYear('voor 1950');
        $vtw54->setRoofType('hellend dak');

        $vtw55 = new Vtw();
        $vtw55->setCode('WT 40');
        $vtw55->setName('luxe appartementencomplex meer dan 4 lagen');
        $vtw55->setBuildingType('40');
        $vtw55->setConstructionYear('na 2000');
        $vtw55->setRoofType('vlak dak');

        $vtw56 = new Vtw();
        $vtw56->setCode('WT 41');
        $vtw56->setName('bovenwoning');
        $vtw56->setBuildingType('41');
        $vtw56->setConstructionYear('tussen 1950 en 1970');
        $vtw56->setRoofType('vlak dak');

        $vtw57 = new Vtw();
        $vtw57->setCode('WT 42');
        $vtw57->setName('vinexwoning');
        $vtw57->setBuildingType('42');
        $vtw57->setConstructionYear('na 1990');
        $vtw57->setRoofType('vlak dak');

        $vtw58 = new Vtw();
        $vtw58->setCode('WT 43');
        $vtw58->setName('galerijflat 2 lagen');
        $vtw58->setBuildingType('43');
        $vtw58->setConstructionYear('na 1990');
        $vtw58->setRoofType('hellend dak');

        $vtw59 = new Vtw();
        $vtw59->setCode('WT 44');
        $vtw59->setName('appartementen in grachtenpand');
        $vtw59->setBuildingType('44');
        $vtw59->setConstructionYear('voor 1900');
        $vtw59->setRoofType('vlak en hellend dak');

        $vtw60 = new Vtw();
        $vtw60->setCode('WT 45');
        $vtw60->setName('eengezinswoning');
        $vtw60->setBuildingType('45');
        $vtw60->setConstructionYear('na 2000');
        $vtw60->setRoofType('vlak dak');

        $vtw61 = new Vtw();
        $vtw61->setCode('WT 46');
        $vtw61->setName('eengezinswoning');
        $vtw61->setBuildingType('46');
        $vtw61->setConstructionYear('na 2000');
        $vtw61->setRoofType('vlak dak');

        $vtw62 = new Vtw();
        $vtw62->setCode('WT 47');
        $vtw62->setName('eengezinswoning');
        $vtw62->setBuildingType('47');
        $vtw62->setConstructionYear('na 2000');
        $vtw62->setRoofType('hellend dak');

        $vtw63 = new Vtw();
        $vtw63->setCode('WT 48R');
        $vtw63->setName('Renovatie eengezinswoning');
        $vtw63->setBuildingType('48R');
        $vtw63->setConstructionYear('tussen 1950 en 1970');
        $vtw63->setRoofType('hellend dak');

        $vtw64 = new Vtw();
        $vtw64->setCode('WT 49');
        $vtw64->setName('duurzame eengezinswoning');
        $vtw64->setBuildingType('49');
        $vtw64->setConstructionYear('na 2015');
        $vtw64->setRoofType('hellend dak');

        $vtw65 = new Vtw();
        $vtw65->setCode('WT 50');
        $vtw65->setName('duurzame galerij appartementen');
        $vtw65->setBuildingType('50');
        $vtw65->setConstructionYear('na 2015');
        $vtw65->setRoofType('vlak dak');

        $vtw66 = new Vtw();
        $vtw66->setCode('WT 51R');
        $vtw66->setName('renovatie eengezinswoning nul op de meter');
        $vtw66->setBuildingType('51R');
        $vtw66->setConstructionYear('tussen 1970 en 1990');
        $vtw66->setRoofType('hellend dak');

        $vtw67 = new Vtw();
        $vtw67->setCode('WT 52');
        $vtw67->setName('energieneutrale eengezinswoning nul op de meter');
        $vtw67->setBuildingType('52');
        $vtw67->setConstructionYear('na 2016');
        $vtw67->setRoofType('hellend dak');

        $vtw68 = new Vtw();
        $vtw68->setCode('WT 135');
        $vtw68->setName('energieneutrale appartementencomplex nul op de meter');
        $vtw68->setBuildingType('135');
        $vtw68->setConstructionYear('na 2019');
        $vtw68->setRoofType('vlak dak');

        $vtw80 = new Vtw();
        $vtw80->setCode('GT 1');
        $vtw80->setName('aangebouwde garagebox');
        $vtw80->setBuildingType('1');
        $vtw80->setConstructionYear('nvt');
        $vtw80->setRoofType('hellend dak');

        $vtw81 = new Vtw();
        $vtw81->setCode('GT 2');
        $vtw81->setName('aangebouwde garagebox');
        $vtw81->setBuildingType('2');
        $vtw81->setConstructionYear('nvt');
        $vtw81->setRoofType('vlak dak');

        $vtw82 = new Vtw();
        $vtw82->setCode('GT 3');
        $vtw82->setName('vrijstaande garagebox');
        $vtw82->setBuildingType('3');
        $vtw82->setConstructionYear('nvt');
        $vtw82->setRoofType('vlak dak');

        $vtw83 = new Vtw();
        $vtw83->setCode('GT 4');
        $vtw83->setName('garagebox in rij');
        $vtw83->setBuildingType('4');
        $vtw83->setConstructionYear('nvt');
        $vtw83->setRoofType('vlak dak');

        $vtw84 = new Vtw();
        $vtw84->setCode('GT 5');
        $vtw84->setName('garagebox onder gebouw');
        $vtw84->setBuildingType('5');
        $vtw84->setConstructionYear('nvt');
        $vtw84->setRoofType('nvt');

        $vtw85 = new Vtw();
        $vtw85->setCode('GT 6');
        $vtw85->setName('garagebox ondergronds');
        $vtw85->setBuildingType('6');
        $vtw85->setConstructionYear('nvt');
        $vtw85->setRoofType('nvt');

        $vtw86 = new Vtw();
        $vtw86->setCode('GT 7');
        $vtw86->setName('garagebox bovengronds');
        $vtw86->setBuildingType('7');
        $vtw86->setConstructionYear('nvt');
        $vtw86->setRoofType('nvt');

        $vtw90 = new Vtw();
        $vtw90->setCode('KT 1');
        $vtw90->setName('grachtenpand gevel(s) in metselwerk');
        $vtw90->setBuildingType('1');
        $vtw90->setConstructionYear('nvt');
        $vtw90->setRoofType('nvt');

        $vtw91 = new Vtw();
        $vtw91->setCode('KT 2');
        $vtw91->setName('grachtenpand gevel(s) gestukadoord en geschilderd');
        $vtw91->setBuildingType('2');
        $vtw91->setConstructionYear('nvt');
        $vtw91->setRoofType('nvt');

        $vtw92 = new Vtw();
        $vtw92->setCode('KT 3');
        $vtw92->setName('klassieke (monumentale) kantoorvilla gevel(s) in metselwerk');
        $vtw92->setBuildingType('3');
        $vtw92->setConstructionYear('nvt');
        $vtw92->setRoofType('nvt');

        $vtw93 = new Vtw();
        $vtw93->setCode('KT 4');
        $vtw93->setName('klassieke (monumentale) kantoorvilla gevel(s) gestukadoord en geschilderd');
        $vtw93->setBuildingType('4');
        $vtw93->setConstructionYear('nvt');
        $vtw93->setRoofType('nvt');

        $vtw94 = new Vtw();
        $vtw94->setCode('KT 5');
        $vtw94->setName('middelhoog jaren zestig-zeventig bouw gevel(s) in metselwerk');
        $vtw94->setBuildingType('5');
        $vtw94->setConstructionYear('nvt');
        $vtw94->setRoofType('nvt');

        $vtw95 = new Vtw();
        $vtw95->setCode('KT 6');
        $vtw95->setName('middelhoog jaren zestig-zeventig bouw gevel(s) in beton');
        $vtw95->setBuildingType('6');
        $vtw95->setConstructionYear('nvt');
        $vtw95->setRoofType('nvt');

        $vtw96 = new Vtw();
        $vtw96->setCode('KT 7');
        $vtw96->setName('laag gevel(s) in metselwerk');
        $vtw96->setBuildingType('7');
        $vtw96->setConstructionYear('nvt');
        $vtw96->setRoofType('nvt');

        $vtw97 = new Vtw();
        $vtw97->setCode('KT 8');
        $vtw97->setName('laag vliesgevel(s)');
        $vtw97->setBuildingType('8');
        $vtw97->setConstructionYear('nvt');
        $vtw97->setRoofType('nvt');

        $vtw98 = new Vtw();
        $vtw98->setCode('KT 9');
        $vtw98->setName('laag gevel(s) in natuursteen');
        $vtw98->setBuildingType('9');
        $vtw98->setConstructionYear('nvt');
        $vtw98->setRoofType('nvt');

        $vtw99 = new Vtw();
        $vtw99->setCode('KT 10');
        $vtw99->setName('laag gevel(s) in beton');
        $vtw99->setBuildingType('10');
        $vtw99->setConstructionYear('nvt');
        $vtw99->setRoofType('nvt');

        $vtw100 = new Vtw();
        $vtw100->setCode('KT 11');
        $vtw100->setName('laag gevel(s) in metaal');
        $vtw100->setBuildingType('11');
        $vtw100->setConstructionYear('nvt');
        $vtw100->setRoofType('nvt');

        $vtw101 = new Vtw();
        $vtw101->setCode('KT 12');
        $vtw101->setName('middelhoog gevel(s) metselwerk');
        $vtw101->setBuildingType('12');
        $vtw101->setConstructionYear('nvt');
        $vtw101->setRoofType('nvt');

        $vtw102 = new Vtw();
        $vtw102->setCode('KT 13');
        $vtw102->setName('middelhoog vliesgevel(s)');
        $vtw102->setBuildingType('13');
        $vtw102->setConstructionYear('nvt');
        $vtw102->setRoofType('nvt');

        $vtw103 = new Vtw();
        $vtw103->setCode('KT 14');
        $vtw103->setName('middelhoog gevel(s) in natuursteen');
        $vtw103->setBuildingType('14');
        $vtw103->setConstructionYear('nvt');
        $vtw103->setRoofType('nvt');

        $vtw104 = new Vtw();
        $vtw104->setCode('KT 15');
        $vtw104->setName('middelhoog gevel(s) in beton');
        $vtw104->setBuildingType('15');
        $vtw104->setConstructionYear('nvt');
        $vtw104->setRoofType('nvt');

        $vtw105 = new Vtw();
        $vtw105->setCode('KT 16');
        $vtw105->setName('middelhoog gevel(s) in metaal');
        $vtw105->setBuildingType('16');
        $vtw105->setConstructionYear('nvt');
        $vtw105->setRoofType('nvt');

        $vtw106 = new Vtw();
        $vtw106->setCode('KT 17');
        $vtw106->setName('hoog vliesgevel(s)');
        $vtw106->setBuildingType('17');
        $vtw106->setConstructionYear('nvt');
        $vtw106->setRoofType('nvt');

        $vtw107 = new Vtw();
        $vtw107->setCode('KT 18');
        $vtw107->setName('hoog gevel(s) in natuursteen');
        $vtw107->setBuildingType('18');
        $vtw107->setConstructionYear('nvt');
        $vtw107->setRoofType('nvt');

        $vtw108 = new Vtw();
        $vtw108->setCode('KT 19');
        $vtw108->setName('hoog gevel(s) in beton');
        $vtw108->setBuildingType('19');
        $vtw108->setConstructionYear('nvt');
        $vtw108->setRoofType('nvt');

        $vtw109 = new Vtw();
        $vtw109->setCode('KT 20');
        $vtw109->setName('hoog gevel(s) in metaal');
        $vtw109->setBuildingType('20');
        $vtw109->setConstructionYear('nvt');
        $vtw109->setRoofType('nvt');

        $vtw110 = new Vtw();
        $vtw110->setCode('KT 21');
        $vtw110->setName('kleinschalige kantoorvilla eigentijds moderne architectuur gevel(s) in metselwerk');
        $vtw110->setBuildingType('21');
        $vtw110->setConstructionYear('nvt');
        $vtw110->setRoofType('nvt');

        $vtw111 = new Vtw();
        $vtw111->setCode('KT 22');
        $vtw111->setName('kleinschalige kantoorvilla eigentijds moderne architectuur gevel(s) in isolatiestukwerk');
        $vtw111->setBuildingType('22');
        $vtw111->setConstructionYear('nvt');
        $vtw111->setRoofType('nvt');

        $vtw112 = new Vtw();
        $vtw112->setCode('KT 23');
        $vtw112->setName('kleinschalige kantoorvilla eigentijds moderne architectuur in natuursteen');
        $vtw112->setBuildingType('23');
        $vtw112->setConstructionYear('nvt');
        $vtw112->setRoofType('nvt');

        $vtw113 = new Vtw();
        $vtw113->setCode('KT 24');
        $vtw113->setName('kleinschalige kantoorvilla eigentijds moderne architectuur in metaal ');
        $vtw113->setBuildingType('24');
        $vtw113->setConstructionYear('nvt');
        $vtw113->setRoofType('nvt');

        $vtw114 = new Vtw();
        $vtw114->setCode('KT 25');
        $vtw114->setName('kleinschalige kantoorvilla eigentijds moderne architectuur in beton');
        $vtw114->setBuildingType('25');
        $vtw114->setConstructionYear('nvt');
        $vtw114->setRoofType('nvt');

        $vtw115 = new Vtw();
        $vtw115->setCode('KT 26');
        $vtw115->setName('middelhoog eigetijds klassieke architectuur gevel(s) in metselwerk');
        $vtw115->setBuildingType('26');
        $vtw115->setConstructionYear('nvt');
        $vtw115->setRoofType('nvt');

        $vtw116 = new Vtw();
        $vtw116->setCode('KT 27');
        $vtw116->setName('laag gevel(s) in metselwerk inclusief parkeergarage');
        $vtw116->setBuildingType('27');
        $vtw116->setConstructionYear('nvt');
        $vtw116->setRoofType('nvt');

        $vtw117 = new Vtw();
        $vtw117->setCode('KT 28R');
        $vtw117->setName('Revitalisatie kantoorgebouw middelhoog gevels in sierbeton elementen');
        $vtw117->setBuildingType('28R');
        $vtw117->setConstructionYear('nvt');
        $vtw117->setRoofType('nvt');

        $vtw118 = new Vtw();
        $vtw118->setCode('KT 40');
        $vtw118->setName('energieneutraal kantoorgebouw nul op de meter duurzaam gebouw onder moderne architectuur');
        $vtw118->setBuildingType('40');
        $vtw118->setConstructionYear('nvt');
        $vtw118->setRoofType('nvt');

        $vtw120 = new Vtw();
        $vtw120->setCode('BT 1');
        $vtw120->setName('kleinschalig gevel(s) in metselwerk');
        $vtw120->setBuildingType('1');
        $vtw120->setConstructionYear('nvt');
        $vtw120->setRoofType('nvt');

        $vtw121 = new Vtw();
        $vtw121->setCode('BT 2');
        $vtw121->setName('kleinschalig gevel(s) in metaal');
        $vtw121->setBuildingType('2');
        $vtw121->setConstructionYear('nvt');
        $vtw121->setRoofType('nvt');

        $vtw122 = new Vtw();
        $vtw122->setCode('BT 3');
        $vtw122->setName('kleinschalig gevel(s) in metselwerk/metaal');
        $vtw122->setBuildingType('3');
        $vtw122->setConstructionYear('nvt');
        $vtw122->setRoofType('nvt');

        $vtw123 = new Vtw();
        $vtw123->setCode('BT 4');
        $vtw123->setName('middelschalig gevel(s) in metselwerk');
        $vtw123->setBuildingType('4');
        $vtw123->setConstructionYear('nvt');
        $vtw123->setRoofType('nvt');

        $vtw124 = new Vtw();
        $vtw124->setCode('BT 5');
        $vtw124->setName('middelschalig gevel(s) in metaal');
        $vtw124->setBuildingType('5');
        $vtw124->setConstructionYear('nvt');
        $vtw124->setRoofType('nvt');

        $vtw125 = new Vtw();
        $vtw125->setCode('BT 6');
        $vtw125->setName('middelschalig gevel(s) in metselwerk/metaal');
        $vtw125->setBuildingType('6');
        $vtw125->setConstructionYear('nvt');
        $vtw125->setRoofType('nvt');

        $vtw126 = new Vtw();
        $vtw126->setCode('BT 7');
        $vtw126->setName('grootschalig gevel(s) in metselwerk');
        $vtw126->setBuildingType('7');
        $vtw126->setConstructionYear('nvt');
        $vtw126->setRoofType('nvt');

        $vtw127 = new Vtw();
        $vtw127->setCode('BT 8');
        $vtw127->setName('grootschalig gevel(s) in metaal');
        $vtw127->setBuildingType('8');
        $vtw127->setConstructionYear('nvt');
        $vtw127->setRoofType('nvt');

        $vtw128 = new Vtw();
        $vtw128->setCode('BT 9');
        $vtw128->setName('grootschalig gevel(s) in metselwerk/metaal');
        $vtw128->setBuildingType('9');
        $vtw128->setConstructionYear('nvt');
        $vtw128->setRoofType('nvt');

        $vtw129 = new Vtw();
        $vtw129->setCode('BT 10');
        $vtw129->setName('klein- tot grootschailg gevel(s) en dak in metaal');
        $vtw129->setBuildingType('10');
        $vtw129->setConstructionYear('nvt');
        $vtw129->setRoofType('nvt');

        $vtw130 = new Vtw();
        $vtw130->setCode('BT 11');
        $vtw130->setName('combinatiegebouw met showroom/serviceruimte kantoor en bedrijfsruimte');
        $vtw130->setBuildingType('11');
        $vtw130->setConstructionYear('nvt');
        $vtw130->setRoofType('nvt');

        $vtw131 = new Vtw();
        $vtw131->setCode('BT 12');
        $vtw131->setName('bedrijfsverzamelgebouw');
        $vtw131->setBuildingType('12');
        $vtw131->setConstructionYear('nvt');
        $vtw131->setRoofType('nvt');

        $vtw132 = new Vtw();
        $vtw132->setCode('BT 13');
        $vtw132->setName('kleinschalig distrubutiecentrum');
        $vtw132->setBuildingType('13');
        $vtw132->setConstructionYear('nvt');
        $vtw132->setRoofType('nvt');

        $vtw133 = new Vtw();
        $vtw133->setCode('BT 14');
        $vtw133->setName('grootschalig distrubutiecentrum');
        $vtw133->setBuildingType('14');
        $vtw133->setConstructionYear('nvt');
        $vtw133->setRoofType('nvt');

        $vtw134 = new Vtw();
        $vtw134->setCode('BT 15');
        $vtw134->setName('garagebedrijf met showroom en kantoren');
        $vtw134->setBuildingType('15');
        $vtw134->setConstructionYear('nvt');
        $vtw134->setRoofType('nvt');

        $vtw135 = new Vtw();
        $vtw135->setCode('BT 16');
        $vtw135->setName('bedrijfsverzamelgebouw prefab betonbouw');
        $vtw135->setBuildingType('16');
        $vtw135->setConstructionYear('nvt');
        $vtw135->setRoofType('nvt');

        $vtw140 = new Vtw();
        $vtw140->setCode('WINT 1');
        $vtw140->setName('individuele winkel / winkel in winkelstraat ouder type');
        $vtw140->setBuildingType('1');
        $vtw140->setConstructionYear('nvt');
        $vtw140->setRoofType('nvt');

        $vtw141 = new Vtw();
        $vtw141->setCode('WINT 2');
        $vtw141->setName('individuele winkel / winkel in winkelstraat recenter type');
        $vtw141->setBuildingType('2');
        $vtw141->setConstructionYear('nvt');
        $vtw141->setRoofType('nvt');

        $vtw142 = new Vtw();
        $vtw142->setCode('WINT 3');
        $vtw142->setName('winkel in het centrum niet dekt ouder type');
        $vtw142->setBuildingType('3');
        $vtw142->setConstructionYear('nvt');
        $vtw142->setRoofType('nvt');

        $vtw143 = new Vtw();
        $vtw143->setCode('WINT 4');
        $vtw143->setName('winkel in het centrum niet dekt recenter type');
        $vtw143->setBuildingType('4');
        $vtw143->setConstructionYear('nvt');
        $vtw143->setRoofType('nvt');

        $vtw144 = new Vtw();
        $vtw144->setCode('WINT 5');
        $vtw144->setName('winkel in het centrum overdekt ouder type');
        $vtw144->setBuildingType('5');
        $vtw144->setConstructionYear('nvt');
        $vtw144->setRoofType('nvt');

        $vtw145 = new Vtw();
        $vtw145->setCode('WINT 6');
        $vtw145->setName('winkel in het centrum overdekt recenter type');
        $vtw145->setBuildingType('6');
        $vtw145->setConstructionYear('nvt');
        $vtw145->setRoofType('nvt');

        $vtw146 = new Vtw();
        $vtw146->setCode('WINT 7');
        $vtw146->setName('kiosk');
        $vtw146->setBuildingType('7');
        $vtw146->setConstructionYear('nvt');
        $vtw146->setRoofType('nvt');

        $vtw147 = new Vtw();
        $vtw147->setCode('WINT 8');
        $vtw147->setName('solitaire supermakrt');
        $vtw147->setBuildingType('8');
        $vtw147->setConstructionYear('nvt');
        $vtw147->setRoofType('nvt');

        $vtw148 = new Vtw();
        $vtw148->setCode('WINT 9');
        $vtw148->setName('grootschalige detailhandelsunit');
        $vtw148->setBuildingType('9');
        $vtw148->setConstructionYear('nvt');
        $vtw148->setRoofType('nvt');

        $vtw149 = new Vtw();
        $vtw149->setCode('WINT 10');
        $vtw149->setName('perifere grootschalige detailhandelsunit');
        $vtw149->setBuildingType('10');
        $vtw149->setConstructionYear('nvt');
        $vtw149->setRoofType('nvt');

        $vtw150 = new Vtw();
        $vtw150->setCode('WINT 11');
        $vtw150->setName('bouwmarkt');
        $vtw150->setBuildingType('11');
        $vtw150->setConstructionYear('nvt');
        $vtw150->setRoofType('nvt');

        $vtw151 = new Vtw();
        $vtw151->setCode('WINT 23');
        $vtw151->setName('energieneutraal solitaire supermarkt nul op de meter');
        $vtw151->setBuildingType('23');
        $vtw151->setConstructionYear('nvt');
        $vtw151->setRoofType('nvt');

        $vtw160 = new Vtw();
        $vtw160->setCode('HT 1R');
        $vtw160->setName('voormalig schoolgebouw');
        $vtw160->setBuildingType('1R');
        $vtw160->setConstructionYear('tussen 1900 en 1930');
        $vtw160->setRoofType('nvt');

        $vtw161 = new Vtw();
        $vtw161->setCode('HT 2R');
        $vtw161->setName('voormalig kantoorgebouw');
        $vtw161->setBuildingType('2R');
        $vtw161->setConstructionYear('tussen 1970 en 1990');
        $vtw161->setRoofType('nvt');

        $vtw162 = new Vtw();
        $vtw162->setCode('HT 3R');
        $vtw162->setName('voormalig fabrieksgebouw');
        $vtw162->setBuildingType('3R');
        $vtw162->setConstructionYear('tussen 1900 en 1930');
        $vtw162->setRoofType('nvt');

        $vtw163 = new Vtw();
        $vtw163->setCode('HT 4R');
        $vtw163->setName('voormalig jongerencentrum');
        $vtw163->setBuildingType('4R');
        $vtw163->setConstructionYear('tussen 1950 en 1970');
        $vtw163->setRoofType('nvt');

        $vtw164 = new Vtw();
        $vtw164->setCode('HT 5R');
        $vtw164->setName('voormalig kantoorgebouw');
        $vtw164->setBuildingType('5R');
        $vtw164->setConstructionYear('nvt');
        $vtw164->setRoofType('nvt');

        $vtw170 = new Vtw();
        $vtw170->setCode('OT 1');
        $vtw170->setName('café / restaurant');
        $vtw170->setBuildingType('1');
        $vtw170->setConstructionYear('nvt');
        $vtw170->setRoofType('nvt');

        $vtw171 = new Vtw();
        $vtw171->setCode('OT 2');
        $vtw171->setName('hotel kleinschalig');
        $vtw171->setBuildingType('2');
        $vtw171->setConstructionYear('nvt');
        $vtw171->setRoofType('nvt');

        $vtw172 = new Vtw();
        $vtw172->setCode('OT 3');
        $vtw172->setName('hotel grootschalig');
        $vtw172->setBuildingType('3');
        $vtw172->setConstructionYear('nvt');
        $vtw172->setRoofType('nvt');

        $vtw173 = new Vtw();
        $vtw173->setCode('OT 4');
        $vtw173->setName('bioscoop');
        $vtw173->setBuildingType('4');
        $vtw173->setConstructionYear('nvt');
        $vtw173->setRoofType('nvt');

        $vtw174 = new Vtw();
        $vtw174->setCode('OT 5');
        $vtw174->setName('discotheek');
        $vtw174->setBuildingType('5');
        $vtw174->setConstructionYear('nvt');
        $vtw174->setRoofType('nvt');

        $vtw175 = new Vtw();
        $vtw175->setCode('OT 6');
        $vtw175->setName('woon-/zorgcomplex');
        $vtw175->setBuildingType('6');
        $vtw175->setConstructionYear('nvt');
        $vtw175->setRoofType('nvt');

        $vtw176 = new Vtw();
        $vtw176->setCode('OT 7');
        $vtw176->setName('gemeentehuis');
        $vtw176->setBuildingType('7');
        $vtw176->setConstructionYear('nvt');
        $vtw176->setRoofType('nvt');

        $vtw177 = new Vtw();
        $vtw177->setCode('OT 8');
        $vtw177->setName('brandweerkazerne');
        $vtw177->setBuildingType('8');
        $vtw177->setConstructionYear('nvt');
        $vtw177->setRoofType('nvt');

        $vtw178 = new Vtw();
        $vtw178->setCode('OT 9');
        $vtw178->setName('theater middelgroot modern');
        $vtw178->setBuildingType('9');
        $vtw178->setConstructionYear('nvt');
        $vtw178->setRoofType('nvt');

        $vtw179 = new Vtw();
        $vtw179->setCode('OT 10');
        $vtw179->setName('theater kleinscahig');
        $vtw179->setBuildingType('10');
        $vtw179->setConstructionYear('nvt');
        $vtw179->setRoofType('nvt');

        $vtw180 = new Vtw();
        $vtw180->setCode('OT 11');
        $vtw180->setName('kleinschalig woon-/zorgcomplex');
        $vtw180->setBuildingType('11');
        $vtw180->setConstructionYear('nvt');
        $vtw180->setRoofType('nvt');

        $vtw181 = new Vtw();
        $vtw181->setCode('OT 12');
        $vtw181->setName('grootschalig woon-/zorgcomplex');
        $vtw181->setBuildingType('12');
        $vtw181->setConstructionYear('nvt');
        $vtw181->setRoofType('nvt');

        $vtw190 = new Vtw();
        $vtw190->setCode('AT 1');
        $vtw190->setName('woonboederij');
        $vtw190->setBuildingType('1');
        $vtw190->setConstructionYear('nvt');
        $vtw190->setRoofType('nvt');

        $vtw191 = new Vtw();
        $vtw191->setCode('AT 2');
        $vtw191->setName('woonboederij');
        $vtw191->setBuildingType('2');
        $vtw191->setConstructionYear('nvt');
        $vtw191->setRoofType('nvt');

        $vtw192 = new Vtw();
        $vtw192->setCode('AT 3');
        $vtw192->setName('vleesvarkensstal');
        $vtw192->setBuildingType('3');
        $vtw192->setConstructionYear('nvt');
        $vtw192->setRoofType('nvt');

        $vtw193 = new Vtw();
        $vtw193->setCode('AT 4');
        $vtw193->setName('loodsgebouw');
        $vtw193->setBuildingType('4');
        $vtw193->setConstructionYear('nvt');
        $vtw193->setRoofType('nvt');

        $vtw194 = new Vtw();
        $vtw194->setCode('AT 5');
        $vtw194->setName('pluimveestal');
        $vtw194->setBuildingType('5');
        $vtw194->setConstructionYear('nvt');
        $vtw194->setRoofType('nvt');

        $vtw195 = new Vtw();
        $vtw195->setCode('AT 6');
        $vtw195->setName('paardenhouderij');
        $vtw195->setBuildingType('6');
        $vtw195->setConstructionYear('nvt');
        $vtw195->setRoofType('nvt');

        $vtw196 = new Vtw();
        $vtw196->setCode('AT 7');
        $vtw196->setName('melkveestal');
        $vtw196->setBuildingType('7');
        $vtw196->setConstructionYear('nvt');
