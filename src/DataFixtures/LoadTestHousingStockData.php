...
class LoadTestHousingStockData extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $buildingType15 = new BuildingType();
        $buildingType15->setId(15);
        $buildingType15->setCode('1210A');
        $buildingType15->setName('flat');
        $buildingType15->setDescription('');
        $buildingType15->setCreationTime();
        $buildingType15->setLastChangeTime();

        $buildingType16 = new BuildingType();
        $buildingType16->setId(16);
        $buildingType16->setCode('1210B');
        $buildingType16->setName('flat');
        $buildingType16->setDescription('');
        $buildingType16->setCreationTime();
        $buildingType16->setLastChangeTime();

        $buildingType17 = new BuildingType();
        $buildingType17->setId(17);
        $buildingType17->setCode('1210C');
        $buildingType17->setName('flat');
        $buildingType17->setDescription('');
        $buildingType17->setCreationTime();
        $buildingType17->setLastChangeTime();

        $buildingType18 = new BuildingType();
        $buildingType18->setId(18);
        $buildingType18->setCode('1210D');
        $buildingType18->setName('flat');
        $buildingType18->setDescription('');
        $buildingType18->setCreationTime();
        $buildingType18->setLastChangeTime();

        $buildingType19 = new BuildingType();
        $buildingType19->setId(19);
        $buildingType19->setCode('1210E');
        $buildingType19->setName('flat');
        $buildingType19->setDescription('');
        $buildingType19->setCreationTime();
        $buildingType19->setLastChangeTime();
        ...
        $buildingAddress214 = new BuildingAddress();
        $buildingAddress214->setConstructionYear();
        $buildingAddress214->setStreetName('Nieuwstraat');
        $buildingAddress214->setHouseNumber(24);
        $buildingAddress214->setAddition('');
        $buildingAddress214->setZipcode('8011TP');
        $buildingAddress214->setCity('Zwolle');
        $buildingAddress214->setBagId('0193200000036234');
        $buildingAddress214->setRentalUnitNumber('ALG1210');
        $buildingAddress214->setDaeb(true);
        $buildingAddress214->setVtw($vtw38);
        $buildingAddress214->setResidentialArea($residentialArea1);
        $buildingAddress214->setBuildingType($buildingType15);
        $buildingAddress214->setLivingType($livingType7);
        $buildingAddress214->setCreationTime();
        $buildingAddress214->setLastChangeTime();

        $buildingAddress215 = new BuildingAddress();
        $buildingAddress215->setConstructionYear();
        $buildingAddress215->setStreetName('Nieuwstraat');
        $buildingAddress215->setHouseNumber(24);
        $buildingAddress215->setAddition('A');
        $buildingAddress215->setZipcode('8011TP');
        $buildingAddress215->setCity('Zwolle');
        $buildingAddress215->setBagId('0193200000028712');
        $buildingAddress215->setRentalUnitNumber('ALG1210');
        $buildingAddress215->setDaeb(true);
        $buildingAddress215->setVtw($vtw38);
        $buildingAddress215->setResidentialArea($residentialArea1);
        $buildingAddress215->setBuildingType($buildingType16);
        $buildingAddress215->setLivingType($livingType7);
        $buildingAddress215->setCreationTime();
        $buildingAddress215->setLastChangeTime();

        $buildingAddress216 = new BuildingAddress();
        $buildingAddress216->setConstructionYear();
        $buildingAddress216->setStreetName('Nieuwstraat');
        $buildingAddress216->setHouseNumber(24);
        $buildingAddress216->setAddition('B');
        $buildingAddress216->setZipcode('8011TP');
        $buildingAddress216->setCity('Zwolle');
        $buildingAddress216->setBagId('0193200000059086');
        $buildingAddress216->setRentalUnitNumber('ALG1210');
        $buildingAddress216->setDaeb(true);
        $buildingAddress216->setVtw($vtw38);
        $buildingAddress216->setResidentialArea($residentialArea1);
        $buildingAddress216->setBuildingType($buildingType17);
        $buildingAddress216->setLivingType($livingType7);
        $buildingAddress216->setCreationTime();
        $buildingAddress216->setLastChangeTime();

        $buildingAddress217 = new BuildingAddress();
        $buildingAddress217->setConstructionYear();
        $buildingAddress217->setStreetName('Nieuwstraat');
        $buildingAddress217->setHouseNumber(24);
        $buildingAddress217->setAddition('C');
        $buildingAddress217->setZipcode('8011TP');
        $buildingAddress217->setCity('Zwolle');
        $buildingAddress217->setBagId('0193200000002912');
        $buildingAddress217->setRentalUnitNumber('ALG1210');
        $buildingAddress217->setDaeb(true);
        $buildingAddress217->setVtw($vtw38);
        $buildingAddress217->setResidentialArea($residentialArea1);
        $buildingAddress217->setBuildingType($buildingType16);
        $buildingAddress217->setLivingType($livingType7);
        $buildingAddress217->setCreationTime();
        $buildingAddress217->setLastChangeTime();

        $buildingAddress218 = new BuildingAddress();
        $buildingAddress218->setConstructionYear();
        $buildingAddress218->setStreetName('Nieuwstraat');
        $buildingAddress218->setHouseNumber(24);
        $buildingAddress218->setAddition('D');
        $buildingAddress218->setZipcode('8011TP');
        $buildingAddress218->setCity('Zwolle');
        $buildingAddress218->setBagId('0193200000021105');
        $buildingAddress218->setRentalUnitNumber('ALG1210');
        $buildingAddress218->setDaeb(true);
        $buildingAddress218->setVtw($vtw38);
        $buildingAddress218->setResidentialArea($residentialArea1);
        $buildingAddress218->setBuildingType($buildingType17);
        $buildingAddress218->setLivingType($livingType7);
        $buildingAddress218->setCreationTime();
        $buildingAddress218->setLastChangeTime();

        $buildingAddress219 = new BuildingAddress();
        $buildingAddress219->setConstructionYear();
        $buildingAddress219->setStreetName('Nieuwstraat');
        $buildingAddress219->setHouseNumber(24);
        $buildingAddress219->setAddition('E');
        $buildingAddress219->setZipcode('8011TP');
        $buildingAddress219->setCity('Zwolle');
        $buildingAddress219->setBagId('0193200000013662');
        $buildingAddress219->setRentalUnitNumber('ALG1210');
        $buildingAddress219->setDaeb(true);
        $buildingAddress219->setVtw($vtw38);
        $buildingAddress219->setResidentialArea($residentialArea1);
        $buildingAddress219->setBuildingType($buildingType18);
        $buildingAddress219->setLivingType($livingType7);
        $buildingAddress219->setCreationTime();
        $buildingAddress219->setLastChangeTime();

        $buildingAddress220 = new BuildingAddress();
        $buildingAddress220->setConstructionYear();
        $buildingAddress220->setStreetName('Nieuwstraat');
        $buildingAddress220->setHouseNumber(24);
        $buildingAddress220->setAddition('F');
        $buildingAddress220->setZipcode('8011TP');
        $buildingAddress220->setCity('Zwolle');
        $buildingAddress220->setBagId('0193200000021106');
        $buildingAddress220->setRentalUnitNumber('ALG1210');
        $buildingAddress220->setDaeb(true);
        $buildingAddress220->setVtw($vtw38);
        $buildingAddress220->setResidentialArea($residentialArea1);
        $buildingAddress220->setBuildingType($buildingType19);
        $buildingAddress220->setLivingType($livingType7);
        $buildingAddress220->setCreationTime();
        $buildingAddress220->setLastChangeTime();

        $buildingAddress221 = new BuildingAddress();
        $buildingAddress221->setConstructionYear();
        $buildingAddress221->setStreetName('Nieuwstraat');
        $buildingAddress221->setHouseNumber(24);
        $buildingAddress221->setAddition('G');
        $buildingAddress221->setZipcode('8011TP');
        $buildingAddress221->setCity('Zwolle');
        $buildingAddress221->setBagId('0193200000036235');
        $buildingAddress221->setRentalUnitNumber('ALG1210');
        $buildingAddress221->setDaeb(true);
        $buildingAddress221->setVtw($vtw38);
        $buildingAddress221->setResidentialArea($residentialArea1);
        $buildingAddress221->setBuildingType($buildingType18);
        $buildingAddress221->setLivingType($livingType7);
        $buildingAddress221->setCreationTime();
        $buildingAddress221->setLastChangeTime();

        $buildingAddress222 = new BuildingAddress();
        $buildingAddress222->setConstructionYear();
        $buildingAddress222->setStreetName('Nieuwstraat');
        $buildingAddress222->setHouseNumber(24);
        $buildingAddress222->setAddition('H');
        $buildingAddress222->setZipcode('8011TP');
        $buildingAddress222->setCity('Zwolle');
        $buildingAddress222->setBagId('0193200000013663');
        $buildingAddress222->setRentalUnitNumber('ALG1210');
        $buildingAddress222->setDaeb(true);
        $buildingAddress222->setVtw($vtw38);
        $buildingAddress222->setResidentialArea($residentialArea1);
        $buildingAddress222->setBuildingType($buildingType19);
        $buildingAddress222->setLivingType($livingType7);
        $buildingAddress222->setCreationTime();
        $buildingAddress222->setLastChangeTime();
        ...
        $block11 = new Block();
        $block11->setCode('ID 1223');
        $block11->setName('ALG1210');
        $block11->setFinancialNumber('5555');
        $block11->setDescription('ALG1210');
        $block11->addBuildingAddress($buildingAddress214);
        $block11->addBuildingAddress($buildingAddress215);
        $block11->addBuildingAddress($buildingAddress216);
        $block11->addBuildingAddress($buildingAddress217);
        $block11->addBuildingAddress($buildingAddress218);
        $block11->addBuildingAddress($buildingAddress219);
        $block11->addBuildingAddress($buildingAddress220);
        $block11->addBuildingAddress($buildingAddress221);
        $block11->addBuildingAddress($buildingAddress222);
        $block11->setCreationTime();
        $block11->setLastChangeTime();
